        ...
        for keyword in config.KEYWORDS.split(","):
            ...
            while (page - start_page + 1) * xhs_limit_count <= config.CRAWLER_MAX_NOTES_COUNT:
                ...
                try:
                    ...
                    utils.logger.error(f"[XiaoHongShuCrawler.search] Error on keyword '{keyword}' page {page}: {e}")
                    break
    ...
    async def get_comments(self, note_id: str, xsec_token: str, semaphore: asyncio.Semaphore):
        ...
        async with semaphore:
            try:
                ...
                # Use reduced crawling interval for comments
                crawl_interval = 1
                ...
                utils.logger.error(f"[XiaoHongShuCrawler.get_comments] Failed to get comments for note {note_id}: {e}")
