...
MYSQL_DB_NAME = os.getenv("MYSQL_DB_NAME", "nev_insight")
...
REDIS_DB_PORT = os.getenv("REDIS_DB_PORT", 6381)  # your redis port
...
# postgres config
POSTGRES_DB_PWD = os.getenv("POSTGRES_DB_PWD", "bettafish")
POSTGRES_DB_USER = os.getenv("POSTGRES_DB_USER", "bettafish")
POSTGRES_DB_HOST = os.getenv("POSTGRES_DB_HOST", "localhost")
POSTGRES_DB_PORT = os.getenv("POSTGRES_DB_PORT", 5444)
